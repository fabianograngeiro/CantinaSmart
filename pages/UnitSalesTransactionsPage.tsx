            ...
            <div className="p-5 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2.5 bg-gray-50 border-2 border-transparent focus:border-rose-500 rounded-xl outline-none text-xs font-bold resize-none dark:bg-zinc-900 dark:border-white/10 dark:text-zinc-100"
                  disabled={deletingTransactionId === '__bulk__'}
                />
              </div>
            </div>
