...
const WhatsAppPage: React.FC<WhatsAppPageProps> = ({ currentUser, activeEnterprise }) => {
  ...
  const loadAiHandoffRequests = async () => {
    ...
    try {
      const data = await ApiService.getWhatsAppAiHandoffRequests(activeEnterprise.id);
  ...
  const loadProviderConfig = async () => {
    try {
      const result = await ApiService.getWhatsAppProviderConfig(activeEnterprise?.id);
